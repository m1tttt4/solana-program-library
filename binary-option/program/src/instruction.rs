...
pub fn initialize_binary_option(
    program_id: Pubkey, // ID of on-chain application
    pool_account: Pubkey, // Upgrade Authority of on-chain application
    escrow_mint: Pubkey, // Unsure
    escrow_account: Pubkey, // Unique address per option [ generated by front-end ]
    long_token_mint: Pubkey, // Unique address per option [ generated by front-end from SPL library]
    short_token_mint: Pubkey, // Unique address per option [ generated by front-end from SPL library]
    mint_authority: Pubkey, // Account that generates the tokens [ fixed - to-be created ]
    update_authority: Pubkey, // Upgrade Authority of on-chain application
    decimals: u8, // 2 = 100, 3 = 1000, etc [ only using 2 for now ]
    expiry:  u64, // Unix timestamp
    strike: f64, // 64-bit float
    underlying_asset_address: Pubkey, // Pyth address
) -> Instruction {
    Instruction {
        program_id,
        accounts: vec![
